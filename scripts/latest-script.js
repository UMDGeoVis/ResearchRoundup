...
{  
    ...
    xmlhttp.open("GET","xmlLatest.xml",false,null,null);
    xmlhttp.send();
...
//        document.write(key);
        ...
        if(year != x[i].getElementsByTagName("year")[0].childNodes[0].nodeValue)
        {
            ...
            document.write("<h3 class=h3Green>");
        ...
        document.write("</td><td><p><b class=h3Green>");
        ...
        if(x[i].getElementsByTagName("honorable").length != 0)
        {
            if(x[i].getElementsByTagName("honorable")[0].childNodes[0].nodeValue == "B")
            {
                document.write("<div class=h3Green align='right'>Best paper</div>");
            }
            else{
                document.write("<div class=h3Green align='right'> Honorable Mention</div>");
            }
        }
        document.write("</td></tr><tr><td></td><td>");
